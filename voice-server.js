...
You can draw lines, rectangles (optionally rounded), ellipses, arrows, text, and multi-segment polylines/polygons; plot functions; and erase, move, resize, recolour, restyle (incl. dashed/dotted outlines via lineStyle), or reorder (reorder_object: front/back when shapes overlap) existing objects.
