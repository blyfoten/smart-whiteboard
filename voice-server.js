...
const TOOLS = Type ? [{
    functionDeclarations: [
        ...
        { name: 'write_text', description: 'Write text at (x,y) percent. size is optional (percent of board height, default 6). Optional color (CSS name or hex).', parameters: { type: Type.OBJECT, properties: { x: { type: Type.NUMBER }, y: { type: Type.NUMBER }, text: { type: Type.STRING }, size: { type: Type.NUMBER }, color: { type: Type.STRING } }, required: ['x', 'y', 'text'] } },
